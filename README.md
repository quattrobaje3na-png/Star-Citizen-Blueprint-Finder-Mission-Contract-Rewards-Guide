...
Never lose track of what you've already unlocked. Check off blueprints as you earn them to automatically hide them from your search results and route calculations. Your inventory saves directly to your device, and you can seamlessly import or export your progress including uploading a raw blueprints.txt file from log-scanning scripts to instantly sync your account's inventory. Pair this with the new Grind Route Planner to calculate the absolute fastest mission path based on your current faction reputation.
